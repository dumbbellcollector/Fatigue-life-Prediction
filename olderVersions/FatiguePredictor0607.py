...
MODEL_PATHS = {
    'lowTS': os.path.join(BASE_DIR, 'model_lowTS.pth'),
    'midTS': os.path.join(BASE_DIR, 'model_midTS.pth'),
    'highTS': os.path.join(BASE_DIR, 'model_highTS.pth')
}
SCALER_X_PATHS = {
    ...
    with tabs[3]: # Model Info Tab
        ...
        if st.session_state.en_results and st.session_state.user_inputs:
            ...
            if ts_value is not None:
                ...
                st.write("- **은닉층:** [192, 384, 352, 224]")
                st.write("- **Dropout:** 0.35")
...
# streamlit run FatiguePredictor0607.py